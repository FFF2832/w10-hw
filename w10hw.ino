...
const char* ssid = "FFF";  // insert your SSID
const char* password = "canada1128";  // insert your password
const char* host1 = "maker.ifttt.com"; //IFTTT server網址
const char* event = "line_fff";  //IFTTT事件名稱
const char* apiKey = "ck2cr_kGSo5fqwvs1Gaw4s";  //IFTTT Applet key
const char* host2 = "api.openweathermap.org";
const char* resource = "/data/2.5/weather?id=1668341&appid=3ad47b62be49d3ecd177b4ff659a4f8c"; 
...
void loop(){
    ...
    double humidity = doc["main"]["humidity"];
     ...
     int value1 = temp-273;
  int value2 = humidity;
   String value3 = weather;
  SendLineNotyfy (String(value1), String(value2),String (value3) );  //Client傳送資料
  
  delay(30000);

//GetWeatherData(String(value1), String(value2));  //Client傳送資料
...
void SendLineNotyfy(String value1, String value2,String value3){
  ...
  String url = "https://maker.ifttt.com/trigger/line_fff/with/key/ck2cr_kGSo5fqwvs1Gaw4s";  //API url
